...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header mdl-layout-scroll">
    <header class="mdl-layout__header">
        <div class="mdl-layout__header-row">
            <!-- Title -->
            <span class="mdl-layout-title">Designation</span>
    ...
    <div class="mdl-layout__drawer">
        ...
        <nav class="mdl-navigation">
            ...
            <?= $this->Html->link(__(' List Designations'), ['action' => 'index'],['class'=>'mdl-navigation__link']) ?>
            <?= $this->Html->link(__(' Add Designations'), ['action' => 'add'],['class'=>'mdl-navigation__link']) ?>
                ...
                <table class="mdl-data-table mdl-js-data-table mdl-data-table--selectable mdl-shadow--2dp">
                    <thead>
                        <tr>
                                        ...
                                        <th><?= $this->Paginator->sort('hierarchy_level') ?></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                                        ...
                                        <td class="actions">
                                <?= $this->Html->link("<i class='material-icons'>link</i>", ['action' => 'view', $designation->id],['escape'=>false]) ?>
                                <?= $this->Html->link( "<i class='material-icons'>edit</i>", ['action' => 'edit', $designation->id],['escape'=>false]) ?>
                                <?= $this->Form->postLink( "<i class='material-icons'>delete</i>", ['action' => 'delete', $designation->id], ['confirm' => __('Are you sure you want to delete # {0}?', $designation->id),'escape'=>false]) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
