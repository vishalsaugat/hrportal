...
class CompaniesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'unique_link' => ['type' => 'string', 'length' => 64, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'image_link' => ['type' => 'string', 'length' => 128, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'unique_link' => 'Lorem ipsum dolor sit amet',
            'city_id' => 1,
            'status' => 1,
            'image_link' => 'Lorem ipsum dolor sit amet',
            'created_at' => '2016-08-07 13:40:05',
            'updated_at' => '2016-08-07 13:40:05'
        ],
    ];
}
